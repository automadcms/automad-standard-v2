...
<@ if @{ :pagelistLayout } = 'grid_frame_portrait' @><@ ../blocks/pagelist/grid_frame_portrait.php @><@ end @>	
<@ if @{ :pagelistLayout } = 'grid_frame_square' @><@ ../blocks/pagelist/grid_frame_square.php @><@ end @>	
<@ if @{ :pagelistLayout } = 'grid_frame_landscape' @><@ ../blocks/pagelist/grid_frame_landscape.php @><@ end @>	
